...
public class UpdateICtoManagerNewOrg extends TestBase {
  ...
  @Test
  public void updateProposedJobcodeICtoManagerNewOrgtest() throws IOException {
    ...
    headcount = common.setManagerJobcode(headcount,supervisoryOrg,"QUE30S");

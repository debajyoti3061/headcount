...
public class SystemLockTest extends TestBaseUI {
    ...
    @Test
    public void SystemLockTest()  throws SQLException {
      ...
      if(!isLocked){
        ...
        validateLock(toolStrip);
    }

    private void validateLock(ToolStrip toolStrip){
        Assert.assertTrue(toolStrip.getProperty("Add","Mui-disabled Mui-disabled")
